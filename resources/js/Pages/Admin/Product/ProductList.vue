...
const fetchBrands = async () => {
    try {
        const response = await axios.get("http://127.0.0.1:8000/api/brands"); // Change URL if needed
                    ...
                    <div
                        ...
                        <div class="relative flex items-center space-x-3 w-full md:w-auto">
                            ...
                            <div v-if="isDropdownOpen" ref="dropdownRef"
                                class="absolute top-12 left-0 z-10 w-48 p-3 bg-white rounded-lg shadow-lg">
                                ...
                                <ul class="space-y-2 text-sm">
                                    <li v-for="brand in brands" :key="brand.id" class="flex items-center">
                                        <input :id="brand.name" type="checkbox" :value="brand.id"
                                            ...
                                            class="w-4 h-4 bg-gray-100 border-gray-300 rounded focus:ring-primary-500">
                                        <label :for="brand.name" class="ml-2 text-sm font-medium text-gray-900">
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr v-for="(product, index) in products" :key="product.id"
                                ...
                                <td class="px-4 py-3">
                                    <span v-if="Number(product.quantity) > 0"
                    ...
                    <ul class="inline-flex items-stretch -space-x-px">
                        <li>
                            <button @click="prevPage" :disabled="currentPage === 1"
                                class="flex items-center justify-center h-full py-1.5 px-3 text-gray-500 bg-white border rounded-l-lg border-gray-300 hover:bg-gray-100 disabled:opacity-50">
                        ...
                        <li v-for="page in totalPages" :key="page">
                            <button @click="goToPage(page)"
                                :class="['flex items-center justify-center text-sm py-2 px-3 border',
                                    currentPage === page ? 'bg-blue-500 text-white' : 'text-gray-500 bg-white border-gray-300 hover:bg-gray-100']">
                                {{ page }}
                            </button>
                        </li>
                        ...
                        <li>
                            <button @click="nextPage" :disabled="currentPage === totalPages"
                                class="flex items-center justify-center h-full py-1.5 px-3 text-gray-500 bg-white border rounded-r-lg border-gray-300 hover:bg-gray-100 disabled:opacity-50">
